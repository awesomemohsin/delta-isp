...
export const BackgroundBeamsWithCollision = ({
    ...
    return (
        ...
        >
            ...
            <div
                ref={containerRef}
                className="absolute bottom-0 bg-neutral-100 w-full inset-x-0 h-2 pointer-events-none"
            ></div>
        </div>
    );
};
    ...
    return (
        <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
            <motion.div
                ...
                className="absolute -inset-px h-2 w-2 rounded-full bg-indigo-500 blur-sm"
            ></motion.div>
            {spans.map((span) => (
                <motion.span
                    key={span}
