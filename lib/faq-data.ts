...
export const faqData: FAQCategory[] = [
    {
        ...
        items: [
            {
                question: "What services does Delta Software & Communication Limited provide?",
                answer: "Delta Software & Communication Limited provides high-speed broadband internet services for residential and corporate customers."
            },
            {
